...
%בדיקת לינאריות 
% fit_type1_islin = fit(type_1_AVG,temp_cal','poly2');
% fit_type2_islin = fit(type_2_AVG,temp_cal','poly2');
% fit_type4_islin = fit(type_4_AVG,temp_cal','poly2');
% fit_type5_islin = fit(type_5_AVG,temp_cal','poly2');
% fit_type6_islin = fit(type_6_AVG,temp_cal','poly2');
% fit_type7_islin = fit(type_7_AVG,temp_cal','poly2');
% fit_type8_islin = fit(type_8_AVG,temp_cal_8','poly2');
% fit_RTD_islin = fit(RTD,temp_cal','poly2');
...
fit_ethanol_RTD = fit(etganol_RTD_AVG,temp_ethanol','poly1');
